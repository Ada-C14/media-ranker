...
describe Work do
  describe 'validations' do
    it 'can be instantiated when all required fields are given' do
    # test each entry from works.yml file:
      works.each do |work|
  ...
  describe 'spotlight' do
    ...
    it 'returns nil when there are no works/media' do
      Work.destroy_all
  ...
  describe 'top media' do
    ...
    it 'returns nil when there are no works/media' do
      ...
      media = %w[book movie album]
      media.each do |category|
        expect(Work.top_works(category)).must_be_nil
      end
    end
